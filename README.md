...
#### Сборка
Из установленного проекты вы можете использовать `./lum.l build file1 file2 file3`<br>
Это файлы которые нужно упаковать. file1 Будет запускаться при запуске собранного проекта. 

На данный момент не обещаю стопроцентрую функциональность собранных скриптов.
